...
$collectionSchema = [
    ...
    'description' => 'Practical career guides for coding, Linux, Python web development, backend development, Deep Learning, Software Testing, WordPress, Graphic Design, Video Editing, Mobile App Development, Cyber Security, DevOps, Cloud Computing, data analytics, Business Intelligence, AI and digital marketing in Jaipur.',
    'inLanguage' => 'en-IN',
    'mainEntity' => [
        '@type' => 'ItemList',
...
<head>
    ...
    <meta name="description" content="Explore Groot Academy guides for coding, Linux, system administration, Django, Python web development, Deep Learning, neural networks, PHP, MySQL, backend development, Software Testing, WordPress, Graphic Design, Video Editing, Flutter, Cyber Security, DevOps, Cloud Computing, data analytics, Power BI and AI in Jaipur.">
    ...
    <meta property="og:description" content="Practical guides for students exploring coding, Linux, system administration, Django, Python web development, Deep Learning, neural networks, PHP, MySQL, backend development, Software Testing, WordPress, Graphic Design, Video Editing, Flutter, Cyber Security, DevOps, Cloud Computing, analytics, Power BI, AI and digital careers.">
