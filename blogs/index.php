...
<head>
    ...
    <meta name="description" content="Explore Groot Academy guides for coding, Computer Networking, CCNA-oriented skills, Git, GitHub, Linux, system administration, Django, Python web development, Deep Learning, PHP, MySQL, Software Testing, WordPress, Cyber Security, DevOps, Cloud Computing, data analytics, Power BI and AI in Jaipur.">
    ...
    <meta property="og:description" content="Practical guides for students exploring coding, Computer Networking, CCNA-oriented learning, Git, GitHub, Linux, system administration, Django, Python web development, Deep Learning, PHP, MySQL, Software Testing, WordPress, Cyber Security, DevOps, Cloud Computing, analytics, Power BI, AI and digital careers.">
