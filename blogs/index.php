...
$collectionSchema = [
    ...
    'description' => 'Practical career guides for coding, development, WordPress, Graphic Design, Video Editing, Mobile App Development, Cyber Security, DevOps, Cloud Computing, data analytics, Business Intelligence, AI and digital marketing in Jaipur.',
    'inLanguage' => 'en-IN',
    'mainEntity' => [
        '@type' => 'ItemList',
...
<head>
    ...
    <meta name="description" content="Explore Groot Academy guides for coding, web development, WordPress, Graphic Design, Video Editing, Flutter, Mobile App Development, Cyber Security, DevOps, Cloud Computing, data analytics, Power BI and AI in Jaipur.">
    ...
    <meta property="og:description" content="Practical guides for students exploring coding, development, WordPress, Graphic Design, Video Editing, Flutter, mobile apps, Cyber Security, DevOps, Cloud Computing, analytics, Power BI, AI and digital careers.">
