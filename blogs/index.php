...
$collectionSchema = [
    ...
    'description' => 'Practical career guides for coding, development, Cloud Computing, data analytics, Business Intelligence, AI, digital marketing and technology learning in Jaipur.',
    'inLanguage' => 'en-IN',
    'mainEntity' => [
        '@type' => 'ItemList',
...
<head>
    ...
    <meta name="description" content="Explore Groot Academy guides for coding, web development, Cloud Computing, AWS, data analytics, Power BI, AI, SQL, Excel and digital marketing in Jaipur.">
    ...
    <meta property="og:description" content="Practical guides for students exploring coding, development, Cloud Computing, AWS, analytics, Power BI, AI, databases and digital marketing careers.">
