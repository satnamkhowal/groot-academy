...
$collectionSchema = [
    ...
    'description' => 'Practical career guides for coding, Python web development, backend development, Software Testing, WordPress, Graphic Design, Video Editing, Mobile App Development, Cyber Security, DevOps, Cloud Computing, data analytics, Business Intelligence, AI and digital marketing in Jaipur.',
    'inLanguage' => 'en-IN',
    'mainEntity' => [
        '@type' => 'ItemList',
...
<head>
    ...
    <meta name="description" content="Explore Groot Academy guides for coding, Django, Python web development, PHP, MySQL, backend development, Software Testing, WordPress, Graphic Design, Video Editing, Flutter, Cyber Security, DevOps, Cloud Computing, data analytics, Power BI and AI in Jaipur.">
    ...
    <meta property="og:description" content="Practical guides for students exploring coding, Django, Python web development, PHP, MySQL, backend development, Software Testing, WordPress, Graphic Design, Video Editing, Flutter, Cyber Security, DevOps, Cloud Computing, analytics, Power BI, AI and digital careers.">
